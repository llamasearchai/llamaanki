...
There are many ways to contribute to LlamaAnki:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamaanki.git
   cd llamaanki
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamaanki.git
   ```
...
By contributing to LlamaAnki, you agree that your contributions will be licensed under the project's MIT License.
